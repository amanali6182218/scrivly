...
const FAQS = [
  ...
  },
  {
    ...
    a: "Each generation uses 3 credits and includes: an SEO-optimized title up to 140 characters, a full description of 400 to 600 words, all 13 Etsy tags, and a listing health score out of 100 with specific improvement tips. Add live price research with a market demand indicator for 2 more credits (5 total).",
  },
  {
